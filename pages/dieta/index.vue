...
export default {
  ...
  data() {
    return {
      item: {
        descripcion: "Rutina de Aclimatacion",
        aporte_calorico_diario: "800",
        proteina: "Facil",
        nivel_carbohidratos: "3",
        nivel_grasas: "2",
      },
      user: {},
      dias: [],
      headers: [
        ...
        {
          text: "De los cuales azucares",
          value: "alimento.carbohidratos_azucar",
        },
  ...
  methods: {
    async getRutina() {
      let response = await this.$axios.get(
        `/api/usersss/${this.user.uuid}/dieta`
      );
